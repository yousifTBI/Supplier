...
class SalesRepositoryImpl @Inject constructor(private val api: SupplierAPI) : SalesRepository {
    ...
    override fun EditItemByBarcode(editProductprice: EditProductprice): Flow<Tasks<ReportSpecificCustomer>> =
        flow {
            try {
    ...
    override fun getAllCustomerTesthandel(userID: String): Flow<State<Tasks<AllCustomers>>> = flow {
