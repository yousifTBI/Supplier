...
import com.tbi.supplierplus.databinding.DailyClosingPurchasesRowBinding

class AdapterPurchasesClosing : ListAdapter<SupplierReport, DailyClosingViewHolder>(DiffCallback) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DailyClosingViewHolder {
        val binding = DataBindingUtil.inflate<DailyClosingPurchasesRowBinding>(
            LayoutInflater.from(parent.context), R.layout.daily_closing_purchases_row, parent, false
        )
...
class DailyClosingViewHolder(private var binding: DailyClosingPurchasesRowBinding) :
