 ...
 * Use the [CustomerSettingPriceFragment.newInstance] factory method to
...
class CustomerSettingPriceFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CustomerSettingPriceFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CustomerSettingPriceFragment().apply {
