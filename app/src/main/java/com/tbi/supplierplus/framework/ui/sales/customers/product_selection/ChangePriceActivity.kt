...
class ChangePriceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
      ...
      //  setContentView(R.layout.activity_change_price)
        ...
        viewModel.getProducers  .observe(this){
            ...
            if (it.isEmpty()&&it.isNullOrEmpty()){}else{
       ...
       viewModel. editProductpricemass.observe(this){
        ...
        binding.button2b.setOnClickListener {
            ...
            if (isvaled()==true){
                viewModel.editItemByBarcode( EditProductprice(  binding.textView3.text.toString().trim(),SharedPreferencesCom.getInstance().gerSharedDistributor_ID(),
    ...
    override fun dispatchKeyEvent(event: KeyEvent?): Boolean {
        ...
        if (event?.action == KeyEvent.ACTION_DOWN && event?.keyCode == KeyEvent.KEYCODE_ENTER) {
            ...
            viewModel.getItemByBarcodeV1API( SharedPreferencesCom.getInstance().gerSharedUser_ID().toString(),barcode.toString().trim(), "0")
